...
#' @param theta_eb Empirical Bayes estimates for subject means (for adaptive)
#' @param psd_eb Empirical Bayes estimates for subject standard deviations (for adaptive)
#' @return Log-likelihood value
#' @export
stage12_loglik_wrapper <- function(params, model_data, adaptive = 1, theta_eb = NULL, psd_eb = NULL) {
  if (adaptive == 1 && !is.null(theta_eb) && !is.null(psd_eb)) {
...
#' @param model_data Prepared model data from prepare_model_data function
#' @param adaptive Use adaptive quadrature (0 = fixed, 1 = adaptive)
#' @param theta_eb Empirical Bayes estimates for each subject (only used if adaptive = 1)
#' @param psd_eb Posterior standard deviations for each subject (only used if adaptive = 1)
#' @return Gradient vector
#' @export
stage12_gradient_wrapper <- function(params, model_data, adaptive = 1, theta_eb = NULL, psd_eb = NULL) {
  if (adaptive == 1) {
...
#' @export
stage12_hessian_wrapper <- function(params, model_data, adaptive = 1, theta_eb = NULL, psd_eb = NULL) {
  if (adaptive == 1) {
